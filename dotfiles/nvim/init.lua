...
====================================================================
====================================================================
Updated to kickstart 3338d3920620861f8313a2745fd5d2be39f39534
...
-- opt.confirm = true -- Raise dialog for unsaved changes instead of failing
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- NOTE: disabled, we keep default quickfix
      ...
      local servers = {
          ...
          settings = {
            ...
            python = {
              analysis = {
                ...
                reportMissingImports = 'none', -- stop expensive import searches
                reportMissingModuleSource = 'none', -- stop source resolution attempts
                useLibraryCodeForTypes = false, -- don't analyze library code
                autoSearchPaths = false, -- disable automatic path searching
                exclude = {
                  '**/node_modules',
                  '**/__pycache__',
                  '.venv',
        ...
        --       cmd_env = {
        --         VIRTUAL_ENV = '.venv',
        --         -- PATH = table.concat { '.venv', 'bin' } .. ':' .. vim.env.PATH,
        ...
        --           },
        --         },
        --         -- rope_autoimport = { -- NOTE: slow as shit
        --         --   enabled = true,
        --         --   memory = true, -- memory only for faster startup
        --         -- },
        --       },
        --     },
        --   },
  ...
  { -- Autocompletion
    ...
    opts = {
      keymap = {
        ...
        ['<tab>'] = {}, -- unmap default scroll doc keys, clashes with copilot
